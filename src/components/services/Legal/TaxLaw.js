...
function TaxLaw() {
  return (
    <div style={{
      ...
      <section className="hero-section" style={{ fontFamily: 'Prompt, sans-serif', background: `linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(https://moneyhub.in.th/wp-content/uploads/2015/06/shutterstock_117803314-300x201.jpg) no-repeat center center/cover` }}>
        <div className="hero-content">
          <h1 className="hero-title" style={{ marginTop : '80px', color: 'rgba(255, 75, 75, 1)' }}> กฎหมายภาษีอากร</h1>
          <p className="hero-subtitle" style={{ color: 'rgba(255, 255, 255, 1)' }} >
            ให้คำปรึกษากฎหมายภาษีอากร ศึกษาและวิเคราะห์ภาระภาษีจากโครงสร้างธุรกิจ 
          </p>
        </div>
      </section>
              ...
              >
                ...
                >
                  <a href="/services" style={{ color: '#ff7070ff', textDecoration: 'none', fontWeight: 600 }}>
                    <span style={{ marginRight: 4, fontSize: 20 }}></span>กฎหมายภาษีอากร
                  </a>
              ...
              <Card className="border-0 shadow-sm" style={{ borderRadius: 18, background: "#fff" }}>
                <Card.Body style={{ padding: 40, marginBottom: 32 }}>
                  ...
                  >
                    ...
                    <h2 className="fw-bold mb-0" style={{ fontSize: 28, letterSpacing: 0.5 }}>กฎหมายภาษีอากร</h2>
                  </motion.div>
                  <motion.div
                  ...
                  >
                    <blockquote className="mb-0" style={{ fontSize: 16, color: '#555', fontStyle: 'italic', borderLeft: '4px solid #db3b3bff', paddingLeft: 16 }}>
                      "ให้คำปรึกษากฎหมายภาษีอากร ศึกษาและวิเคราะห์ภาระภาษีจากโครงสร้างธุรกิจ และวางแผนภาษีอย่างมีประสิทธิภาพ"
                    </blockquote>
                  </motion.div>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
